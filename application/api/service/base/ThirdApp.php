...
class ThirdApp{
    ...
    public static function add($data,$inner=false){
            ...
            $res = BeforeModel::CommonGet("ThirdApp",$modelData);
            ...
            $MainRes = BeforeModel::CommonSave("ThirdApp",$data);
            ...
            if($MainRes>0){
                ...
                $res = BeforeModel::CommonSave('ThirdApp',$modelData);               
                if($res>0){
                    $modelData = [];
    ...
    public static function get($data,$inner=false){
        ...
        try{
            $res = BeforeModel::CommonGet("ThirdApp",$data);
    ...
    public static function update($data,$key='更新',$inner=false){
        ...
        $res = BeforeModel::CommonSave('ThirdApp',$data);
    ...
    public static function realDelete($data,$key='真实删除',$inner=false){
        ...
        $data = preSearch($data);
        $res = BeforeModel::CommonDelete("ThirdApp",$data);
        if($inner){
            return $res;
        }else{
            dealUpdateRes($res,$key); 
